...
class ControlErrorsDirective {
    ...
    ngOnInit() {
        ...
        if (!this.controlErrorsClass || ((_a = this.controlErrorsClass) === null || _a === void 0 ? void 0 : _a.length) === 0) {
        ...
        if (!this.controlCustomClass || ((_b = this.controlCustomClass) === null || _b === void 0 ? void 0 : _b.length) === 0) {
    ...
    valueChanges() {
        ...
        const classesAdd = Array.isArray(this.controlCustomClass)
            ...
            : (_b = (_a = this.controlCustomClass) === null || _a === void 0 ? void 0 : _a.split(/\s/)) !== null && _b !== void 0 ? _b : [];
        if (controlErrors) {
    ...
    buildConfig() {
        ...
        }, this.config), { controlErrorsOn: {
                async: (_c = (_a = this.controlErrorsOnAsync) !== null && _a !== void 0 ? _a : (_b = this.config.controlErrorsOn) === null || _b === void 0 ? void 0 : _b.async) !== null && _c !== void 0 ? _c : true,
                blur: (_f = (_d = this.controlErrorsOnBlur) !== null && _d !== void 0 ? _d : (_e = this.config.controlErrorsOn) === null || _e === void 0 ? void 0 : _e.blur) !== null && _f !== void 0 ? _f : true,
                change: (_j = (_g = this.controlErrorsOnChange) !== null && _g !== void 0 ? _g : (_h = this.config.controlErrorsOn) === null || _h === void 0 ? void 0 : _h.change) !== null && _j !== void 0 ? _j : false
            } });
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.1", ngImport: i0, type: ControlErrorsDirective, decorators: [{
        ...
        return [{ type: i0.ViewContainerRef }, { type: i0.ElementRef }, { type: undefined, decorators: [{
                        type: Inject,
